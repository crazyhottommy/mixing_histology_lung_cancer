...
find *wbc.maf | parallel 'perl ~/vcf2maf/maf2vcf.pl --input-maf {} --output-dir . --ref-fa /scratch/genomic_med/apps/annot/bundle/human_g1k_v37_decoy.fasta'

cd /Users/mtang1/projects/mixing_histology/data/vcfs
...
plot_96_profile(mut_mat[,c(1:16)], ymax = 0.1) 
